...
需要使用大部分精力开发的视频网站系统为了充分降低开发风险，特意在开发之前进行可行性分析这个验证系统开发是否可行的步骤。本文就会从技术角度，经济角度，还有用户使用的程序的运行角度进行综合阐述。
...
管理员假如要操作系统提供的功能，那么管理员就要在系统的登录界面，填写管理员登录的账号信息，填写相应的密码信息，管理员需要保证这两者能够验证身份的账号以及密码信息的正确性，这样管理员就可以通过登录界面进入系统后台操作界面。下图就是开发的程序软件视频网站系统它的操作流程图。
...
图5.2视频分享管理页面【管理员管理视频分享，可以添加，修改，删除视频分享信息。下图就是视频分享管理页面】
![alt text](images/image-5.png)

图5.3 视频排名管理页面【管理员管理视频排名，可以添加，修改，删除视频排名信息。下图就是视频排名管理页面】
![alt text](images/image-6.png)

图5.4 交流论坛管理页面【管理员管理交流论坛，可以添加，修改，删除交流论坛信息。下图就是交流论坛管理页面】
![alt text](images/image-7.png)

图5.5 留言板管理页面【管理员管理留言板，可以添加，修改，删除留言板信息。下图就是留言板管理页面】
